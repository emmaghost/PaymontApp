<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Paymon Laravel Livewire</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Catalogos</h6>
            </li>
                <li class="nav-item">
                        <a class="nav-link {{ Route::currentRouteName() == 'admin.categories' ? 'active' : '' }}" href="{{ route('admin.categories') }}">
                            ...
                            {{ in_array(request()->route()->getName(),['admin.categories']) ? 'text-white' : 'text-dark' }}"></i>
                        </div>
                            <span class="sidenav-normal"> Categorías </span>
                        </a>
                </li>
                <li class="nav-item">                                              
                    <a class="nav-link {{ Route::currentRouteName() == 'admin.age-groups' ? 'active' : '' }}" href="{{ route('admin.age-groups') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Grupos de Edad</span>
                </a>
            ...
            <li class="nav-item mt-2">
                ...
                <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'admin.courses' ? 'active' : '' }}"
                    href="{{ route('admin.courses') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['admin.courses']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text">Administrar Cursos</span>
                </a>
                </li>
            ...
            @role('user')  
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'courses.catalog' ? 'active' : '' }}" href="{{ route('courses.catalog') }}">
                    <span class="sidenav-mini-icon"> C </span>
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-book-open ps-2 pe-2 text-center {{ request()->routeIs('courses.catalog') ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="sidenav-normal"> Cursos Disponibles </span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'user.courses' ? 'active' : '' }}"
